...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
	<?php
		...
		if ( is_single() ) :
			if ($medicine_shop_single_post_feature_image == '1') :
    ...
    <?php endif; 
		...
		if ($medicine_shop_post_feature_image == '1') :
			if ( has_post_thumbnail() ) : ?>
				<div class="blog-thumb"><?php the_post_thumbnail(); ?></div>
			<?php endif; ?>
	    <?php endif; 
	...
	<?php
	    if ( is_singular() ) : ?>
            <ul class="comment-timing">
				...
				<?php endif; ?>
				<li>
		          <i class="fas fa-clock pe-1"></i> <?php echo esc_html(get_the_time('H:i')); ?> <?php esc_html_e('HOURS', 'medicine-shop'); ?>
		        </li>
			</ul>
	<?php
	    else : ?>

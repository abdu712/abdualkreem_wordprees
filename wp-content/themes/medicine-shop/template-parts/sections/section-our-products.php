<?php 
  $medicine_shop_aboutus = get_theme_mod('medicine_shop_our_products_show_hide_section', '0');
  
  if ($medicine_shop_aboutus == '0') {
?>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6">
        ...
        <?php } ?>
        <?php if (get_theme_mod('medicine_shop_our_product_product_category_first') != '') { ?>
          <div class="product-main p-3">
            <?php if (class_exists('woocommerce')) : ?>
              <?php
              $medicine_shop_selected_category = get_theme_mod('medicine_shop_our_product_product_category_first');
      ...
      <div class="col-lg-6 col-md-6">
        ...
        <?php } ?>
        <?php if (get_theme_mod('medicine_shop_our_product_product_category') != '') { ?>
          <div class="product-main p-3">
            <?php if (class_exists('woocommerce')) : ?>
              <?php
              $medicine_shop_selected_category = get_theme_mod('medicine_shop_our_product_product_category');
              if ($medicine_shop_selected_category) {
                $medicine_shop_args = array(
                  'post_type'      => 'product',
                  'posts_per_page' => 50,

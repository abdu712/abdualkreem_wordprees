...
if ( class_exists( 'WP_Customize_Control' ) ) :
     ...
     * @since 1.0.0
     */
	class Medicine_Shop_Control_Upgrade extends WP_Customize_Control {
        ...
        protected function content_template() {
            ?>
                <div class="mt-upgrade-pro-wrapper">
                    ...
                    <# } #>
                    <a class="mt-upgrade-btn" href="<?php echo esc_url( MEDICINE_SHOP_PRO_THEME_URL ); ?>" target="_blank"><?php esc_html_e( 'upgrade to pro', 'medicine-shop' ); ?></a>

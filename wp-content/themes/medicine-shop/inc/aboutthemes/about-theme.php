...
if ( ! defined( 'MEDICINE_SHOP_FREE_THEME_URL' ) ) {
	define( 'MEDICINE_SHOP_FREE_THEME_URL', 'https://www.seothemesexpert.com/wordpress/free-medicine-wordpress-theme/' );
}
if ( ! defined( 'MEDICINE_SHOP_PRO_THEME_URL' ) ) {
	define( 'MEDICINE_SHOP_PRO_THEME_URL', 'https://www.seothemesexpert.com/wordpress/medicine-shop-website-template/' );
}
if ( ! defined( 'MEDICINE_SHOP_FREE_DOC_URL' ) ) {
	define( 'MEDICINE_SHOP_FREE_DOC_URL', 'https://www.seothemesexpert.com/documentation/expert-medicine-shop/' );
}
if ( ! defined( 'MEDICINE_SHOP_DEMO_THEME_URL' ) ) {
	define( 'MEDICINE_SHOP_DEMO_THEME_URL', 'https://seothemesexpert.com/demo/medicine-shop/' );
}
if ( ! defined( 'MEDICINE_SHOP_DOCS_THEME_URL' ) ) {
    define( 'MEDICINE_SHOP_DOCS_THEME_URL', 'https://www.seothemesexpert.com/docs/medicine-shop-website-template-pro/' );
}
...
if ( ! defined( 'MEDICINE_SHOP_THEME_BUNDLE_URL' ) ) {
    define( 'MEDICINE_SHOP_THEME_BUNDLE_URL', 'https://www.seothemesexpert.com/wordpress/wordpress-theme-bundle/' );
}
		...
		<div class="main-col-box">
			<div class="feature-section two-col">
				<div class="card">
					...
					<p><?php esc_html_e( 'Take a step towards excellence, try our premium theme. Use Code', 'medicine-shop' ) ?><span class="usecode"><?php esc_html_e('" STEPro10 "', 'medicine-shop'); ?></span></p>
			...
			<div class="about-theme">
				...
				<div class="theme-description">
					<p class="actions">
						...
						<a href="<?php echo esc_url( MEDICINE_SHOP_DOCS_THEME_URL ); ?>" class="docs button button-secondary" target="_blank"><?php esc_html_e( 'Theme Instructions', 'medicine-shop' ); ?></a>
						<a href="<?php echo esc_url( MEDICINE_SHOP_THEME_BUNDLE_URL ); ?>" class="bundle button button-secondary" target="_blank"><?php esc_html_e( 'Buy Bundle', 'medicine-shop' ); ?></a>
					</p>
				</div>

 ...
 * Slug: titan-bookseller/footer-default
 * Categories: footer
...
<p class="has-text-align-right has-link-color">
	...
	printf(
		...
		esc_html__( 'Proudly powered by %s', 'titan-bookseller' ),
		'<a href="' . esc_url( __( 'https://wordpress.org', 'titan-bookseller' ) ) . '" rel="nofollow">WordPress</a>'
	)
	?>
</p>
<!-- /wp:paragraph --></div>
